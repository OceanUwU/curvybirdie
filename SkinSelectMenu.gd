...
const SKINS = [ #[name, price, layer, angle]
    ['default', 0, 1, 0.0/13],
    ['defaultgreen', 50, 1, 1.0/13],
    ['defaultdarkblue', 25, 1, 2.0/13],
    ['defaultblue', 5, 1, 3.0/13],
    ['defaultpurple', 10, 1, 4.0/13],
    ['defaultmagenta', 45, 1, 5.0/13],
    ['defaultpink', 20, 1, 6.0/13],
    ['defaultred', 5, 1, 7.0/13],
    ['defaultorange', 15, 1, 8.0/13],
    ['defaultbrown', 40, 1, 9.0/13],
    ['defaultblack', 30, 1, 10.0/13],
    ['defaultwhite', 35, 1, 11.0/13],
    ['defaultyellow', 5, 1, 12.0/13],
    
    ['toucan', 250, 2, 18.0/20],
    ['royal', 100, 2, 19.0/20],
    ['robo', 1000, 2, 0.0/20],
    ['candy', 150, 2, 1.0/20],
    ['star', 200, 2, 2.0/20],
    ['aeroplanedark', 9999, 2, 8.0/20],
    ['aeroplane', 1000, 2, 9.0/20],
    ['bushsummer', 600, 2, 11.0/20],
    ['bushspring', 650, 2, 12.0/20],
    ...
    ['sus', 450, 3, 11.0/26],
    ['godot', 500, 3, 12.0/26],
    ['bushwinter', 750, 3, 14.0/26],
    ['bushautumn', 800, 3, 15.0/26],
